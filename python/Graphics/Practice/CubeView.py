...
from Graphics.Practice.Vector import Vector3
...
def run():
    ...
    # ball = pygame.image.load("/Users/Silversmith/Documents/Development/Projects/Connect4X/Graphics/Practice/ball.jpg").convert()
    ...
    ball_w, ball_h = 50, 50  # put in a random size
    ...
    while True:
        ...
        for point in points:
            ...
            temp_vec = point - camera_position
            x = temp_vec.x
            y = temp_vec.y
            z = temp_vec.z
            ...
            if z > 20.:
                ...
                # screen.blit(pygame.Rect, (x-ball_center_x, y-ball_center_y))
                pygame.draw.circle(screen, (255, 255, 255), (int(x-ball_center_x), int(y-ball_center_y)), 5)
        ...
        fov_text = font.render("field of view = {}".format(int(fov)), True, white)
        screen.blit(fov_text, (5, 35))
        txt = "viewing distance = {}".format(viewing_distance)
